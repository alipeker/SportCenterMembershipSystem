	...
	$(document)
			.ready(
					function() {
						...
						for (var j = 0; j < members.length; j++) {
							html += "<li><a class='btn-primary' href='./editprofilememberbranchmanager?email="+members[j].email+"'>Edit Profile</a>"
									+"<a class='btn-danger' href='./deleteprofilememberbranchmanager?email="+members[j].email+"'>Delete Profile</a></li>";
						}
...
<body>
	...
	<div  style='padding-left:10px;'><a class='btn-success' href='./branchmanagercreateuser'>Create Member</a></div>
