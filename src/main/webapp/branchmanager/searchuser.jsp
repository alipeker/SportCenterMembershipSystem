...
<script>
	...
	function Editprofile() {
		window.location = currentLocation2 + "editbranchmanagerprofile";
	}
			...
			carddiv += '<div class="col-xs-12 col-sm-6 col-md-4">'
				...
				+ '<div class="image-flip">'
					+'<div class="mainflip">'
						+'<div class="frontside">'
							+'<div class="card">'
								+'<form class="card-body text-center" action="viewprofilebranchmanager">'
									+'<input type="text" name="email" value="' + object["email"] +  '" class="hide"></input><p>'
										+'<img class=" img-fluid" src="${pageContext.request.contextPath}/resources/images/' +object["userimage"]+ '" alt="card image">'
									+'</p>'
									+'<h4 class="card-title">' +object["name"]+ " " +object["surname"] + '</h4>'
									+'<p class="card-text">' +object["email"]+ '</p>'
									+'<input type="submit" class="btn btn-primary btn-sm" value="See Profile" />'
								+'</form>'
							+'</div>'
						+'</div>'
					+'</div>'
