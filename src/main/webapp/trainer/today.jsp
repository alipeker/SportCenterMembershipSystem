	...
	$(document)
			.ready(
					function() {
						...
						var html = "<form action='attendprocess' type='post'><input style='display:none' name='lessonid' value='${lessonid}' />";

						html += "<div class='row'><div class='col-md-3'> <ul class='nav nav-pills' style='display:block;'>";
						for (var j = 0; j < members.length; j++) {
							html += "<li style='padding-top:5px;'><a data-toggle='tab' href='#"+members[j].id+"'>"
									+ members[j].name + "</a></li>";
						}
						html += "</ul><div style='text-align:center;padding-top:50px;'><input type='submit' value='Take Attendance' class='btn-primary' /></div></div><div class='col-md-2'><ul class='list-unstyled'>";
						
						for (var j = 0; j < members.length; j++) {
							html+="<li><select class='form-control' name='"+members[j].id+"'><option value='1'>Here</option><option value='2'>Not Here</option></select></li>"
						}
...
<body>
	...
	<div class="collapse navbar-collapse" id="navbarCollapse">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item active"><a class="nav-link menuitem"
				href="./manipulatelessontrainer">Manipulate Lessons </a></li>
			<li class="nav-item active"><a class="nav-link menuitem"
