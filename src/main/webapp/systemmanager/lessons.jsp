	...
	<div class="container">
		...
		<div class="row" style="padding-left: 10px; padding-top: 35px;">
			<div class="col-md-12"
				...
				<form type="post" action="editclassprocess">
					<div class="row">
							...
							<div class="container" method="post">
								<div class="row">
									<div class="col-md-6 mb-3">
										...
										</b><br /> <input name="coursename" value=${coursename
											} class="form-control-static" />
									</div>
									<div class="col-md-6 mb-3">
										<b> <label>Branch</label>
										</b><br /> <select class="form-control" name="branch" id="branch">
										</select> 
									</div>
								</div>
								<div class="row">
									<div class="col-md-6 mb-3">
										...
										</b><br /> <p name="trainername" class="form-control-static" >${trainername}</p>
									</div>
									<div class="col-md-6 mb-3">
										<b> <label>Branch Offices</label>
										</b><br /> <select class="form-control" name="branchoffice" id="branchs">
										</select> 
									</div>
								</div>
								<div class="row">
										...
										<div class="form-group">
											<div class="input-group">
												...
												<input type="date" class="form-control" name="lessondate"
													value="${lessondate}" required></input>
											</div>
										</div>
									</div>
									<div class="col-md-6">
								...
								<div class="row">
									<div class="col-md-6">
										...
										</b><br /> <input value=${lessondates } name="lessondates"
											class="form-control-static" />
						...
						<div class="col-md-3 mb-3">
							<div style="padding-top: 40px; padding-left: 30px;">
								<input class="hide" name="id" value=${id}> <input
									type="submit" class="btn-success" value="Save Class Properties" />
							</div>
						</div>
					</div>
				</form>
