...
<script>
	...
	for(var j=0; j<branchs2.length; j++){
		html+="<option value="+branchs2[j].name+">"+branchs2[j].name+"</option>";
		
	}
	document.getElementById("branchs2").innerHTML = html;
	}
</script>
</head>
...
<body>
	...
	<a class="navbar-brand" href="./systemmanagerprofile"> <img
		class="logo"
		src="${pageContext.request.contextPath}/resources/images/logo.png"
		alt="logo"> <sup style="color: white; font-size: 16px;">System
			Manager</sup>
	</a>
	...
	<div class="collapse navbar-collapse" id="navbarCollapse">
		<ul class="navbar-nav mr-auto">
			<li class="nav-item active"><a class="nav-link menuitem"
				href="./manipulatelessonsystemmanager">Manipulate Lessons </a></li>
			<li class="nav-item active"><a class="nav-link menuitem"
				href="./systemmanagermembers">Members </a></li>
				<li class="nav-item active"><a class="nav-link menuitem"
			...
			<li class="nav-item active"><a class="nav-link menuitem"
				href="./systemmanagercalendar">Calendar </a></li>
		</ul>
	...
	<div class="container-fluid">
		...
		<form method="post" action="systemmanagercreatestaffprocess"
			enctype="multipart/form-data"
			style="padding-left: 40%; padding-top: 40px;">
			<div class="row">
				<div class="well center-block">
						...
						<div class="col-md-12 col-xs-12 col-sm-12">
							<div class="form-group">
								<div class="input-group">
									...
									<select class="form-control" name="optradio" id="branchs">
										<option name="optradio" value="T">Trainer</option>
										<option name="optradio" value="B">Branch Manager</option>
										<option name="optradio" value="S">System Manager</option>
									</select>
								</div>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-12 col-xs-12 col-sm-12">
							<select class="form-control" name="branchoffice" id="branchs2">
