	...
	$(document)
			.ready(
					function() {
						...
						for (var j = 0; j < members.length; j++) {
							html += "<li><a class='btn-primary' href='./editprofilestaffsystemmanager?email="+members[j].email+"'>Edit Profile</a>"
									+"<a class='btn-danger' href='./deleteprofilestaffsystemmanager?email="+members[j].email+"'>Delete Profile</a></li>";
						}
						...
						for (var j = 0; j < members.length; j++) {
							html += "<div id='"+members[j].id+"' class='tab-pane fade'><div style='padding-left: 10px;padding-bottom: 100px;'><div class='row'><div class='col-md-3 mb-3'>"
									+ "<img width='150px' height:='200px' src='${pageContext.request.contextPath}/resources/images/"+members[j].picture+"'/><br><br><br><b style='padding-left:15px;'>"+members[j].role+"</b></div><div class='col-md-9 mb-3'><div class='container' method='post'><div class='row'>"
...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row" style="padding-left: 10px; padding-top: 20px;">
			...
			<div class="col-md-12">
				<b style="color: #16385d; font-size: 20px;">Staff List</b>
				<div id="classes"></div>
			</div>
		</div>
	</div>

	<div  style='padding-left:10px;'><a class='btn-success' href='./systemmanagercreatestaff'>Create Staff</a></div>
